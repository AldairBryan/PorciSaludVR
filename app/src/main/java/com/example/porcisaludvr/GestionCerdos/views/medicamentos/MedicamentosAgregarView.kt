...
@Composable
fun MedicamentosAgregarView(navController: NavController, viewModel: MedicamentosViewModel){
    Scaffold (
        topBar = {
            CenterAlignedTopAppBar(
                title = {
                    Text(text = "Agregar Medicamentos", color= Color.White, fontWeight = FontWeight.Bold)
                },
        ...
        ContentMedicamentosAgregarView(it, navController, viewModel)
    }
}

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun ContentMedicamentosAgregarView(it: PaddingValues, navController: NavController, viewModel: MedicamentosViewModel){
